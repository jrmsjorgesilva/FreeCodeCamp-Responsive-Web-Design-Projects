...
const DocsBody = () => {
  ...
  return (
    <main id="main-doc" className={styles.main__doc}>
      <section className={styles.docs} id="Introduction">
      ...
      <section className={styles.docs} id="What_you_should_already_know">
      ...
      <section className={styles.docs} id="JavaScript_and_Java">
      ...
      <section className={styles.docs} id="Hello_world">
      ...
      <section className={styles.docs} id="Variables">
      ...
      <section className={styles.docs} id="Declaring_variables">
      ...
      <section className={styles.docs} id="Variable_scope">
      ...
      <section className={styles.docs} id="Constants">
      ...
      <section className={styles.docs} id="if...else_statement">
      ...
      <section className={styles.docs} id="Function_declarations">
      ...
      <section className={styles.docs} id="Reference">
